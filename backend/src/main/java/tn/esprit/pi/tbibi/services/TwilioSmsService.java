    ...
    public void sendSms(String to, String body) {
        ...
        try {
            ...
            if (message.getErrorCode() != null) {
                log.error("[Twilio] SMS to {} FAILED with Twilio error code {} - {}", to, message.getErrorCode(), message.getErrorMessage());
            ...
            throw new RuntimeException("Twilio error " + e.getCode() + ": " + e.getMessage() + " | Hint: " + getTwilioErrorHint(e.getCode()), e);
